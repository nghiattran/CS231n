...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    dx, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dx,
                                                                      temporal_cache)

    if self.cell_type == 'rnn':
      dx, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dx,
                                                                   forward_cache)
    elif self.cell_type == 'lstm':
      dx, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dx,
                                                                    forward_cache)
